...
<xsl:text>{
</xsl:text><xsl:text>"name":"Publication Date",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e2003" as="xs:integer+"><xsl:sequence select="if(exists(/eml/dataset/pubDate)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e2003)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e2003" as="xs:integer+"><xsl:sequence select="count(/eml/dataset/pubDate)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e2003)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6114" as="xs:integer+"><xsl:sequence select="if(exists(/eml/dataset/coverage/temporalCoverage//*)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6114)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6114" as="xs:integer+"><xsl:sequence select="count(/eml/dataset/coverage/temporalCoverage//*)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6114)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>

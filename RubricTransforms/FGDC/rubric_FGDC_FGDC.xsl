...
<xsl:text>{
</xsl:text><xsl:text>"name":"Originating Organization",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e3896" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e3896)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e3896" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e3896)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Publication Date",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e2006" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubdate)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e2006)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e2006" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubdate)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e2006)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Purpose",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e2852" as="xs:integer+"><xsl:sequence select="if(exists(/idinfo/descript/purpose)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e2852)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e2852" as="xs:integer+"><xsl:sequence select="count(/idinfo/descript/purpose)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e2852)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Status",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e9076" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/status)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e9076)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e9076" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/status)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e9076)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Update Frequency",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6520" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/status/update)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6520)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6520" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/status/update)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6520)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6109" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/timeperd/timeinfo/rngdates)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6109)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6109" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/timeperd/timeinfo/rngdates)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6109)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Bounding Box",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e4290" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e4290)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e4290" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/spdom/bounding)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e4290)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Distribution Liability",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6565" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/distinfo/distliab)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6565)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6565" as="xs:integer+"><xsl:sequence select="count(/metadata/distinfo/distliab)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6565)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Metadata Standard Citation",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6333" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/metainfo/metstdn)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6333)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6333" as="xs:integer+"><xsl:sequence select="count(/metadata/metainfo/metstdn)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6333)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Metadata Standard Version",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6361" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/metainfo/metstdv )) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6361)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6361" as="xs:integer+"><xsl:sequence select="count(/metadata/metainfo/metstdv )"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6361)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Turnaround",</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemExists.d1e6590" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/distinfo/distrib/storder/turnaro)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemExists.d1e6590)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Discovery-Mandatory.itemCounts.d1e6590" as="xs:integer+"><xsl:sequence select="count(/metadata/distinfo/distrib/storder/turnaro)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Discovery-Mandatory.itemCounts.d1e6590)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
